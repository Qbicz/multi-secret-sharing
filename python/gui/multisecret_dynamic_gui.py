...
class Ui_multisecret_gui(object):
    def setupUi(self, multisecret_gui):
        ...
        self.widget.setGeometry(QtCore.QRect(20, 20, 691, 181))
        ...
        self.number_of_secrets = QtWidgets.QSpinBox(self.widget)
        ...
        self.number_of_users = QtWidgets.QSpinBox(self.widget)
